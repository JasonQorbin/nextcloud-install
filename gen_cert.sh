# This script is meant to generate a new self-signed certificate for the Nextcloud instance to for communication with
# the Traefik proxy in it's internal network communication. This is a security requirement of Nextcloud and if that
# communication cannot be over https then certain features get disabled and an error message is shown in the admin panel.
